...
The engineering team must determine whether Flinders Street and Southern Cross crossings can use the same design and materials.
According to project requirements, the average difference in hourly pedestrian flow between the two sites must be no more than 80 people per hour.
